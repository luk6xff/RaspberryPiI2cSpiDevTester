...
class Ui_RegistersView(object):
    def setupUi(self, RegistersView):
        ...
        self.bitmaskTableWidget.setColumnCount(4)
        ...
        item = QtGui.QTableWidgetItem()
        self.bitmaskTableWidget.setHorizontalHeaderItem(3, item)
    ...
    def retranslateUi(self, RegistersView):
        ...
        self.bitmaskTableWidget.horizontalHeaderItem(2).setText(QtGui.QApplication.translate("RegistersView", "Attr", None, QtGui.QApplication.UnicodeUTF8))
        self.bitmaskTableWidget.horizontalHeaderItem(3).setText(QtGui.QApplication.translate("RegistersView", "Value", None, QtGui.QApplication.UnicodeUTF8))
