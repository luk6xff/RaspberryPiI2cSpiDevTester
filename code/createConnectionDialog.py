...
class ConnectionDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        grid.addWidget(usernameLabel, 1, 0, Qt.AlignLeft | Qt.AlignTop)
        grid.addWidget(self.usernameText, 1, 1, Qt.AlignLeft)
        grid.addWidget(passwordLabel, 2, 0, Qt.AlignLeft | Qt.AlignTop)
        grid.addWidget(self.passwordText, 2, 1, Qt.AlignLeft)
    ...
    # @property lets you to retrieve data by CreateConnectionDialog.getHostname
    @property
